...
/** El like es siempre del EVENTO (no hay like por sesión: ver EventInteractionsService). */
export async function likeEventAction(
  ...
  try {
    ...
    await eventInteractionsService.registerLike(id, tokens.decodedToken.uid, liked);
